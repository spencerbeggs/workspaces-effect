...
import { checkLockfileIntegrity } from "../../src/layers/integrity.js";
import { LockfileData, ResolvedPackage } from "../../src/schemas/lockfile.js";
...
describe("checkLockfileIntegrity", () => {
	...
	it("skips workspace specifiers", async () => {
		...
		const fs = mockFs({
			...
			"/project/packages/lib/package.json": JSON.stringify({
				name: "@my/lib",
			}),
		});
